    ...
    stats: [
      {
        ...
        afterLabelEn: "January 2026 (record)",
        afterLabelHi: "जनवरी 2026 (रिकॉर्ड)",
        afterValueEn: "$709.41 billion",
        afterValueHi: "$709.41 अरब",
        afterValueNumeric: 709.41,
      },
      {
        ...
        afterValueEn: "Beyond ₹90 / $1",
        afterValueHi: "₹90 / $1 के पार",
      },
    ],
    sources: [
      {
