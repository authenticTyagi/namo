...
- **8 categories, 28 entries** (2026-09-15: added Agriculture & Farmer Welfare and Environment & Renewable Energy, 3 entries each, via 2 parallel research subagents — both categories' entries are deliberately `impactType: "mixed"` with real honest caveats, not just wins): Economy-Infra-Digital (8), Space & Science (3), Foreign Policy & Diplomacy (3), Defense & Security (2), Currency/Prices/Inflation (2), Welfare & Social Schemes (4: Ayushman Bharat, Swachh Bharat, PMAY, Jal Jeevan Mission), Agriculture & Farmer Welfare (3: PM-KISAN, PMFBY crop insurance, MSP procurement), Environment & Renewable Energy (3: renewable capacity growth, International Solar Alliance, forest cover/ISFR) — all cited, all with before/after stat comparisons.
- **10 editorials hand-authored** (2026-09-15): one per existing entry across 6 categories, honestly toned (5 positive, 5 mixed — none forced positive), landed as `pending_review` same as everything else. Still need admin approval from `/admin/editorials` before they're live.
